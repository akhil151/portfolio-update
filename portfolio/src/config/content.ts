...
export const achievements: Achievement[] = [
  {
    ...
    badge: "' 1",
    icon: "/achievements/creathon.jpeg",
    hoverImg: "/achievements/creathon.jpeg",
    url: socials.linkedin,
  },
  {
    name: "Project Expo — 1st Prize (Design Thinking)",
    badge: "' 1",
    icon: "/achievements/projectexpo.jpeg",
    hoverImg: "/achievements/projectexpo.jpeg",
    url: socials.linkedin,
  },
  {
    name: "SCI-FIXX — 3rd Place (Bug Fixing)",
    badge: "' 3",
    icon: "/achievements/scifixx.jpeg",
    hoverImg: "/achievements/scifixx.jpeg",
    url: socials.linkedin,
  },
  {
    name: "4+ National-Level Hackathons",
    badge: "' 4+",
    icon: "/achievements/hackathons.jpeg",
    hoverImg: "/achievements/hackathons.jpeg",
    url: socials.github,
  },
];
